...
* 镜像概述 — https://help.aliyun.com/zh/ecs/user-guide/image-overview
* 图说镜像 — https://help.aliyun.com/zh/ecs/user-guide/tew-mirror
* 查找镜像 — https://help.aliyun.com/zh/ecs/user-guide/find-an-image

(原始页面中的交互元素、登录提示和无关导航已移除以便于文档迁移与阅读。)
