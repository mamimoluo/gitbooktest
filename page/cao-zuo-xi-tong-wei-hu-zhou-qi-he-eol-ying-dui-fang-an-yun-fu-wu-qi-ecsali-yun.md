# 操作系统维护周期和EOL应对方案-云服务器 ECS-阿里云

以下为阿里云帮助中心各类产品与服务的汇总目录（保留原始链接）。
...
* 性能测试 PTS: https://help.aliyun.com/zh/pts/
...
* 智能科教内容生成平台: https://help.aliyun.com/product/2846391.html
...
* 阿里云交易和账单管理 API: https://help.aliyun.com/product/87964.html
...
* 操作系统生命周期概述: https://help.aliyun.com/zh/ecs/user-guide/eol-overview
* CentOS 操作系统: https://help.aliyun.com/zh/ecs/user-guide/options-for-dealing-with-centos-linux-end-of-life
* Alibaba Cloud Linux 操作系统: https://help.aliyun.com/zh/ecs/user-guide/solution-for-alibaba-cloud-linux-2-entering-the-els-phase
* Ubuntu 操作系统: https://help.aliyun.com/zh/ecs/user-guide/ubuntu-eol-solution
* Red Hat Enterprise Linux 操作系统: https://help.aliyun.com/zh/ecs/user-guide/actions-to-take-when-red-hat-7-enters-the-extended-life-phase
* Windows Server 操作系统: https://help.aliyun.com/zh/ecs/user-guide/windows-server-eol-guide
* 其他操作系统: https://help.aliyun.com/zh/ecs/user-guide/other-operating-systems
* 为 ECS 实例购买软件许可证: https://help.aliyun.com/zh/ecs/user-guide/purchase-software-licenses-for-ecs-instances
* 使用 KMS 域名激活 ECS 实例的正版 Windows Server 系统: https://help.aliyun.com/zh/ecs/user-guide/how-to-use-the-kms-domain-name-to-activate-a-windows-instance-in-a-vpc

（本页为目录汇总，所有链接保留原始目标与查询参数。）
