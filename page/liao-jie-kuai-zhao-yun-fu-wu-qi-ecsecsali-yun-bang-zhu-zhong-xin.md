# 了解快照-云服务器 ECS(ECS)-阿里云帮助中心

以下为阿里云帮助文档中的产品与服务分类目录，保留原始链接与查询参数。
...
* 图说快照: https://help.aliyun.com/zh/ecs/user-guide/tew-snapshot
* 快照原理: https://help.aliyun.com/zh/ecs/user-guide/how-do-snapshots-work

（已移除页面导航、登录提示、页脚图片与与主内容无关的交互元素）
